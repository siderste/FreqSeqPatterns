...
public class LocalMeanShift {
    ...
    public List<DoubleVector> cluster(List<PointWithTrajid> points, List<Integer> weights,
    ...
    private List<VectorDistanceTuple> getNeighbors( DoubleVector vec ) {
        List<VectorDistanceTuple> results = new ArrayList<LocalMeanShift.VectorDistanceTuple>();
        for(int i=0; i<points.size(); i++) {
